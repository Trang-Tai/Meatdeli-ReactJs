...
import './FreshChicken.scss';

const searchProductLine = [
    PRODUCT_LINE.CHICKEN,
]

function FreshChicken(props) {
    ...
    console.log(customListProducts)

    return (
        <div className="fresh-chicken-container">
            <div className="grid wide">
                <div className="fresh-chicken-content">
                    <span className="fresh-chicken-title" onClick={() => navigate(`/collections/${searchProductLine.join('-')}`)}>Thịt Gà Tươi</span>
                    <div className="row">
                        <div className="fresh-chicken-list col c-7-2 m-7-2 s-12">
                        ...
                        <div className="fresh-chicken-banner col c-4-8 m-4-8 s-12">
                            <img className="fresh-chicken-banner-img" src="https://theme.hstatic.net/200000507659/1000893368/14/section_pro_banner.jpg?v=219" onClick={() => navigate(`/collections/${searchProductLine.join('-')}`)} />
                        </div>
                    </div>
                    <div className="fresh-chicken-view-all">
